...
mr_protocol::status Coordinator::submitTask(int taskType, int index, bool &success) {
	...
	if (completedMapCount>=files.size()&&completedReduceCount>=4)
	{
